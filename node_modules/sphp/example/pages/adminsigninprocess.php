...
debug_to_console("Student Sign-in");
					...
					if(isset($_POST['username'])) {
						$admin_name = stripslashes($_REQUEST['username']);    // removes backslashes
						...
						$query    = "SELECT * FROM `admin` WHERE admin_name='$admin_name' AND admin_pwd='$password'";
      ...
      <div class="navbar-inner">
        ...
        <div class="title">Admin Login</div>
								  ...
								  <p>Click here to <a href="/admin-signin/">Login</a> again.</p>
