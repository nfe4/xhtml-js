...
<div class="page inner-details job-details">
	...
	<div class="page-content content-area pt-0 bottom-sp100">
		<div class="head-details">
			...
			<h3 class="title">Operating Systems - II</h3>
			<p class="mb-0 fs-20 mt-5">BVSD-21</p>
		</div>
		
		<div class="container">
			<div class="row align-items-center mb-30 mt-10">
				<div class="col-60">
					<h4 class="mt-0 mb-10">Divya</h4>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            <div class="timeline-item-text">File Systems: Functions of the System, File Access and Allocation Methods, Directory Systems: Structured Organizations, Directory and File Protection Mechanisms.
</div>
          </div>
        </div>
      </div>
      <div class="timeline-item">
        ...
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            ...
            <div class="timeline-item-text">Concurrent Processes: Introduction, Parallel Processing, Control Structure for Indicating Parallelism, Mutual Exclusion, Critical Section Problem, Semaphores, Classical Process Co-ordination Problems and Their Solutions, Inter-process Communications.</div>
          </div>
        </div>
      </div>
      <div class="timeline-item">
        ...
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            ...
            <div class="timeline-item-text">Deadlocks: Introduction, Deadlock Characterization, Deadlock Prevention and Avoidance, Deadlock Detection and Recovery, Practical Considerations.</div>
          </div>
        </div>
      </div>
      <div class="timeline-item">
        ...
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            ...
            <div class="timeline-item-text">Case Study: UNIX System: Introduction, History, The Shell, The Kernel, File System, Process Management, Memory Management, I/O System.
Case Study: DOS: Overview of MS-DOS, Fundamental Concepts, MS-DOS System Calls, Implementation of MS-DOS.</div>
          </div>
        </div>
      </div>
      <!-- <div class="timeline-item">
