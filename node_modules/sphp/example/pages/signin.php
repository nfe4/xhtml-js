			...
			<div class="container">
				...
				<div class="toolbar tabbar tabbar-swiper tab-style-1">
					<div class="toolbar-inner">
						...
						<a href="/signup/" class="tab-link">REGISTER</a>
					</div>
				</div>
				<div class="tabs">
					<div class="tab tab-active form-elements tabs">
						<form action="pages/teachersignin.php" method="post" class="tab tab-active" id="tabA1">
							<div class="list">
								<ul class="row">
						...
						<form action="/pages/resetprocess_teacher.php" method="post" class="tab" id="tabA2">
							<div class="list">
								<ul>
									<li class="item-content col-100 item-input">
										<div class="item-inner">
									...
									<li class="item-content col-100 item-input">
										<div class="item-inner">
											<div class="item-input-wrap">
												<input type="text" name="username" placeholder="Username" class="form-control" required validate/>
											</div>
										</div>
									</li>
									<li class="item-content col-100 item-input">
										<div class="item-inner">
											<div class="item-input-wrap">
												<input type="text" name="email" placeholder="Email" class="form-control" required validate/>
											</div>
										</div>
									</li>
								</ul>
