	...
	<div class="page-content content-area pt-0">
		<div class="head-details">
			<div class="container">
				...
				<p class="location">Poonam Rani</p>
				<a href="#" class="block-btn" style="justify-content: center;">
					<h5 class="title"><strong class="text-primary">Syllabus</strong></h5>
		...
		<div class="container">
			...
			<ul class="content-info mb-40">
				<li>
					...
					<p>Telephone</p>
					<h5 class="mt-5 mb-0">+12 3456 789</h5>
				</li>
				<li>
					<i class="fas fa-envelope text-primary"></i>
					<p>Email</p>
					<h5 class="mt-5 mb-0">100 - 150</h5>
				</li>
				<li>
			...
			<div class="title-bar">
				<h4 class="dz-title">About Crewmate Studios</h4>
			</div>
			<p class="mb-30">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in</p>
			
			<div class="title-bar">
				<h4 class="dz-title">Gallery</h4>
			</div>
			<!-- Featured Swiper -->
			<div data-space-between="20" data-slides-per-view="auto" data-centered-slides="false" class="swiper-container swiper-init mb-30 main-swiper gallery-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="dz-media">
							<img src="img/gallery/pic4.jpg" alt="">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="dz-media">
							<img src="img/gallery/pic6.jpg" alt="">
						</div>
						<div class="dz-media">
							<img src="img/gallery/pic7.jpg" alt="">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="dz-media">
							<img src="img/gallery/pic5.jpg" alt="">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="dz-media">
							<img src="img/gallery/pic8.jpg" alt="">
						</div>
						<div class="dz-media">
							<img src="img/gallery/pic9.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
