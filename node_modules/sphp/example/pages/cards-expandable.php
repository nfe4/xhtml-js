      ...
      <div class="card card-expandable">
        <div class="card-content">
          ...
          <div class="card-content-padding">
            ...
            <p>Framework7 is definitely for you if you decide to build iOS and Android hybrid app (Cordova or PhoneGap)
      ...
      <div class="card card-expandable">
        <div class="card-content">
          ...
          <div class="card-content-padding">
            ...
            <p>
              <a href="#"
                class="button button-fill button-round button-large card-close color-yellow text-color-black">Close</a>
            </p>
          </div>
        </div>
      </div>
