...
<div class="page inner-details job-details">
	...
	<div class="page-content content-area pt-0 bottom-sp100">
		<div class="head-details">
			...
			<p class="mb-0 fs-20 mt-5">BVSD-33</p>
		</div>
		
		<div class="container">
			<div class="row align-items-center mb-30 mt-10">
				<div class="col-60">
					<h4 class="mt-0 mb-10">Poonam Rani</h4>
					<p class="ma-0">Theory</p>
				</div>
				<div class="col-40">
					<div class="clearfix text-align-right">
						<p class="mb-0 fs-12 mt-15">B.Voc - SD - I</p>
						<p class="mb-0 fs-12 mt-15">Semester - II</p>
					</div>
				</div>
			</div>
</div>
		<div class="container">
			<div class="row align-items-center mb-30 mt-10">
				<div class="col-60">
					<p class="ma-0">Maximum marks: 100</p>
					<p class="ma-0">Time: 3 hours</p>
				</div>
				<div class="col-40">
					<div class="clearfix text-align-right">
						<p class="mb-0 fs-12 mt-15">External: 80</p>
						<p class="mb-0 fs-12 mt-15">Internal: 20</p>
					</div>
				</div>
			</div>
			...
			<button class="button col button-round">Syllabus</button>
  <script>
  ...
  button[0].addEventListener('click', () => {
	document.getElementById('tog').classList.toggle('active');
      ...
      <p>Note: Examiner will be required to set NINE questions in all.  Question Number 1 will consist of objective type/short-answer type questions covering the entire syllabus. In addition to the compulsory question there will be four units i.e. Unit-I to Unit-IV. Examiner will set two questions from each Unit of the syllabus.
Student will be required to attempt FIVE questions in all. Question Number 1 will be compulsory.   In addition to compulsory question, student will have to attempt four more questions selecting one question from each Unit. All questions will carry equal marks.
</p>

<div class="timeline">
      <div class="timeline-item">
        <div class="timeline-item-date">Unit I</div>
        <div class="timeline-item-divider"></div>
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            <div class="timeline-item-text">Introduction to Internet and World Wide Web , Web Browsers, Web server, Web page, Web site.
Web Publishing: Hosting your site, Internet Service Provider, Planning & Designing Web Site, Steps for Developing Sites, Choosing the Contents, Home Page, Domain Names, Creating a Web Site.
HTML: Introduction, Tags, HTML Standards, Creating Web Pages, Adding Background Colors, Page Formatting, Break Tag, Paragraph Tag, HR Tag, Preformatted Text, Working with Headings, Images, Linking Web Pages, Tables and Lists, Forms, Buttons.
</div>
          </div>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-item-date">Unit II</div>
        <div class="timeline-item-divider"></div>
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            
            <div class="timeline-item-text">Introduction to CSS, Properties and Values, Defining CSS Styles, Using Links and Style, Importing and Embedding Style Sheets, In lining Styles, Using Attributes, Class Attributes, ID Attributes, Using Elements, Cascading Style Sheets, Selectors, Class Selectors, ID Selectors, Contextual Selectors.</div>
          </div>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-item-date">Unit III</div>
        <div class="timeline-item-divider"></div>
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            
            <div class="timeline-item-text">Introduction to JavaScript, Guidelines, Functions, Operators, Precedence, Looping, Boolean Object, Data Object, Math Objects, JavaScript Window, Opening and Closing Windows, Frame Object, Image Object, Loading Image, Creating Animation, JavaScript Style Sheet, Working with Layers, Layer Animation.</div>
          </div>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-item-date">Unit IV</div>
        <div class="timeline-item-divider"></div>
        <div class="timeline-item-content">
          <div class="timeline-item-inner">
            
            <div class="timeline-item-text">Concept and use of Front Page: Building Basics Web Pages, Use of Number List, Bulleted List, Definition List, Menu List, Use of Tables, Images, Sound, Video, Links & Bookmarks, Styles Sheets, Frame Sets, Using Advanced Features. 
Photoshop - Basics, Using Colours, Painting with Pixels, Using Transformation, Layers, Masks and Paths, Enhancing Features. 
Flash – Basics, Working with Graphics, Colours, Transforming and Adjusting Graphics, Working with Text & Symbols, Animation, Tweening, Working with Flash Moving and use of Dreamweaver.
</div>
          </div>
        </div>
      </div>
